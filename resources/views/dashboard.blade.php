...
@endsection
@section('title')
    Built on Service, and Focused on Style.
@endsection
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
      ...
      <footer class="br-footer">
        ...
        <div class="footer-right d-flex align-items-center">
          ...
          <a target="_blank" class="pd-x-5" href="https://www.facebook.com/billahbaqi"><i class="fa fa-facebook tx-20"></i></a>
          <a target="_blank" class="pd-x-5" href="https://twitter.com/mdbaqibillah"><i class="fa fa-twitter tx-20"></i></a>
        </div>
      </footer>
    </div><!-- br-mainpanel -->
@endsection
