        ...
        <div class="row pd-x-15">
            <div class="br-pagebody mg-t-1 col-lg-12">
                <div class="br-section-wrapper">
                    ...
                    @endif
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Edit Your Products Here</h6>
                    <form action="{{ url('/admin/products/update') }}/{{ $product_all->id }}"
                                ...
                                <div class="col-lg-6 bd-r bd-info">
                                    ...
                                    <div class="form-group pd-r-15">
                                        ...
                                        <select name="category_id" class="form-control">
                                            <option value="{{ $product_all->category_id }}">
                                                {{ App\Models\Category::find($product_all->category_id)->category_name }}
                                            </option>
                                    ...
                                    <div class="form-group pd-r-15">
                                        ...
                                        <select name="subcategory_id" class="form-control">
                                            <option value="{{ $product_all->subcategory_id }}">
                                                {{ App\Models\Subcategory::find($product_all->subcategory_id)->subcategory_name }}
                                            </option>
                                    ...
                                    <div class="form-group pd-r-15">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input multiple name="product_thumbnail[]" type="file" id="file2"
                                                    class="form-control">
                                            ...
                                            <div class="col-lg-4 pd-t-30">
                                                <img id="image_preview_id"
                                                    src="{{ asset('uploads/product') }}/{{ $product_all->product_photo }}"
                                                    class="ht-120" alt="">
                                            </div>
                                        </div>
                                    ...
                                    @if (!empty($thumbnails_id))
                                        <div class="form-group pd-r-15">
                                            <div class="row">
                                                @foreach ($thumbnails as $thumbnail)
                                                    <div class="col-lg-2 text-center">
                                                        <img id="image_preview_id"
                                                            src="{{ asset('uploads/product/thumbnails') }}/{{ $thumbnail->product_thumbnail }}"
                                                            class="ht-100" alt="">
                                                        <a href="{{ url('admin/products/thumbnail-delete') }}/{{ $thumbnail->id }}"
                                                            class="tx-danger" style="text-decoration: none;"><i
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group pd-l-15">
                                        ...
                                        <input class="form-control" type="text" name="product_name"
                                            placeholder="Enter Product Name" value="{{ $product_all->product_name }}">
                                        @error('product_name')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group pd-l-15">
                                        ...
                                        <textarea name="product_description" rows="5" class="form-control"
                                            placeholder="Type Your Product details...">{{ $product_all->product_description }}</textarea>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="product_price" type="text" class="form-control"
                                                        ...
                                                        value="{{ $product_all->product_price }}">
