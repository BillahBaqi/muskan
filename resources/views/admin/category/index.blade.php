        ...
        <div class="row pd-x-15">
                    ...
                    <table class="table table-bordered table-colored table-dark">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th scope="col" class="wd-25p">Action</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="br-pagebody mg-t-1 pd-l-15 col-lg-4">
                ...
                <div class="br-section-wrapper">
                    ...
                    <form action="{{ url('/admin/category/insert') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <img id="image_preview_id" class="ht-100" alt="">
                                </div>
                            </div>
