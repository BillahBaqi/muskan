                                ...
                                <div class="tab-content col-sm-12 col-12">
                                    ...
                                    <div id="stripe-payment" class="tab-pane fade pt-3 order-area">
                                        <form role="form" action="{{ route('stripe.post') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-12 required">
                                                    <p>Full Name *</p>
                                                    <input readonly type="text" value="{{ Auth::user()->name }}">
                                                </div>
                                                ...
                                                <div class="col-sm-6 col-12 required">
                                                    <p>Phone No. *</p>
                                                    <input value="{{ old('c_phone') }}" type="text" name="c_phone">
                                                    @error('c_phone')
                                                        <div style="margin-top:-25px;" class="text-danger">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-sm-6 col-12 required">
                                                    <p>Postcode/ZIP</p>
                                                    <input value="{{ old('c_zip') }}" type="text" name="c_zip">
                                                    @error('c_zip')
                                                        <div style="margin-top:-25px;" class="text-danger">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-12 required">
                                                    <p>Your Address *</p>
                                                    <input value="{{ old('c_address') }}" type="text" name="c_address" class="">
                                                    @error('c_address')
                                                        <div style="margin-top:-25px;" class="text-danger">
                                                            {{ $message }}
                                                        </div>
