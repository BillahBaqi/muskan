<!-- ########## START: LEFT PANEL ########## -->
<div class="br-logo"><a href="{{ url('/') }}"><img class="wd-180"
            src="{{ asset('dashboard/img/muskan-logo.PNG') }}" alt=""></a></div>
<div class="br-sideleft overflow-y-auto">
    <label class="sidebar-label pd-x-15 mg-t-20">Navigation</label>
    <div class="br-sideleft-menu">
        <a href="{{ url('/admin') }}" class="br-menu-link @yield('dashboard')">
        ...
        <a href="{{ url('/admin/users') }}" class="br-menu-link @yield('users')">
            <div class="br-menu-item">
        ...
        <a href="{{ url('/admin/category') }}" class="br-menu-link @yield('category')">
            <div class="br-menu-item">
        ...
        <a href="{{ url('/admin/subcategory') }}" class="br-menu-link @yield('subcategory')">
            <div class="br-menu-item">
        ...
        <a href="#" class="br-menu-link  @yield('products')">
            <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ url('/admin/products') }}" class="nav-link @yield('product-list')">All Products</a></li>
            <li class="nav-item"><a href="{{ url('/admin/products-add') }}" class="nav-link @yield('product-add')">Add Product</a></li>
        </ul>
...
{{--     <label class="sidebar-label pd-x-15 mg-t-25 mg-b-20 tx-info op-9">Information Summary</label>
    ...
    <div class="info-list">
        ...
        <div class="d-flex align-items-center justify-content-between pd-x-15 mg-t-20">
            <div>
                <p class="tx-10 tx-roboto tx-uppercase tx-spacing-1 tx-white op-3 mg-b-2 space-nowrap">CPU Usage
                </p>
        ...
        <div class="d-flex align-items-center justify-content-between pd-x-15 mg-t-20">
            <div>
                <p class="tx-10 tx-roboto tx-uppercase tx-spacing-1 tx-white op-3 mg-b-2 space-nowrap">Daily
                    Traffic</p>
        ...
        <nav class="nav">
                            ...
                            <div class="media pd-x-20 pd-y-15">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="tx-12 mg-b-0">A wonderful serenity has taken possession of my
                                        entire soul, like these sweet mornings of spring.</p>
                                </div>
                            </div><!-- media -->
                        </a>
                        <!-- loop ends here -->
                            ...
                            <div class="media pd-x-20 pd-y-15">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="tx-12 mg-b-0">When, while the lovely valley teems with vapour
                                        around me, and the meridian sun strikes...</p>
                                </div>
                            </div><!-- media -->
                        </a>
                            ...
                            <div class="media pd-x-20 pd-y-15">
                                ...
                                <div class="media-body">
                                    <p class="tx-13 mg-b-0 tx-gray-700"><strong class="tx-medium tx-gray-800">Julius
                                        ...
                                        with you on your conversation with <strong class="tx-medium tx-gray-800">Ronnie
                                            Mara</strong></p>
            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    ...
                    <img src="{{ asset('uploads/profile') }}/{{ Auth::user()->profile_image }}" class="wd-32 ht-32 rounded-circle" alt="">
                    <span class="square-10 bg-success"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="{{ url('/admin/profile') }}"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
                        <li>
